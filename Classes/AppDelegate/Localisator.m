...
//  CustomLocalisator
//
//  Created by LiKaShing on 05/03/2014.
//
...
- (id)init
{
    ...
    if (self)
    {
        ...
        _availableLanguagesArray        = @[@"English", @"Arabic"];
        ...
        if (languageSaved != nil && ![languageSaved isEqualToString:@"English"])
        {
...
-(BOOL)setLanguage:(NSString *)newLanguage
{
    ...
    if ([newLanguage isEqualToString:@"English"])
    {
        self.currentLanguage = [newLanguage copy];
