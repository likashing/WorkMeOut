...
- (id)initWithTitle:(NSString *)aTitle options:(NSArray *)aOptions
{
    ...
    if (self = [super initWithFrame:rect])
    {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(50,
                                                                   210,
                                                                   260,
                                                                   250)];
...
{
    rect = CGRectMake(40, 160, 290, 280);
    ...
    CGRect titleRect = CGRectMake(x + 30, y + 10,
                                  width, 30);
    CGRect separatorRect = CGRectMake(x, y + 45,
                                      width, 2);
