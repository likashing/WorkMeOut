...
- (void)setup
{
    ...
    [self.textField setFont:[UIFont fontWithName:@"System" size:17]];
...
//            }
        ...
        block((CGRect){x, y, lineWidth, token.frame.size.height});
        x += lineWidth + margin;
        rowCount++;
    }
}
